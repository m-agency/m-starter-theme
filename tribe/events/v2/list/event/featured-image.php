...
?>
<div class="tribe-events-calendar-list__event-featured-image-wrapper tribe-common-g-col w-full md:!w-1/3">
	<a
		...
		<img
			...
			<?php endif; ?>
			class="tribe-events-calendar-list__event-featured-image rounded-lg aspect-4/3 object-cover"
