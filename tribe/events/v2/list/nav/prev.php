...
?>
<li class="tribe-events-c-nav__list-item tribe-events-c-nav__list-item--prev !inline-block !justify-center !w-auto !mx-2">
	<a
		href="<?php echo esc_url( $link ); ?>"
		rel="prev"
		class="btn btn-primary !bg-light-blue rounded tribe-events-c-nav__prev tribe-common-b2 tribe-common-b1--min-medium"
